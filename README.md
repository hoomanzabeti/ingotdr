...
clf = ingot.INGOTClassifier(lambda_p=10, lambda_z=0.01, false_positive_rate_upper_bound=0.1, max_rule_size=20, solver_name='CPLEX_PY')
...
complete objective function with these two variable would be:
